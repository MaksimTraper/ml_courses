...
def fit_agent(q_param = 0.9, iteration_n = 20, trajectory_n = 50, need_schedule=False):
    ...
    plt.plot(mean_total_rewards, label=f'q = {q_param}, iteration_n = {iteration_n}, trajectory_n = {trajectory_n}, need_scheduler = {need_scheduler}')
    ...
    for q in qs:
        for iteration_n in iterations_n:
            for trajectory_n in trajectorys_n:
                ...
                print(f'q = {q}, iteration_n = {iteration_n}, trajectory_n = {trajectory_n}, need_scheduler = {need_scheduler}')

                fit_agent(q, iteration_n, trajectory_n, need_scheduler)
